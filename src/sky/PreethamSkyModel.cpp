// https://github.com/diharaw/sky-models/blob/master/src/preetham_sky_model.cpp
...
void PreethamSkyModel::set_render_uniforms(Shader &shader)
{
    shader.setUniform("u_Direction", m_direction);
    shader.setUniform("p_A", A);
    shader.setUniform("p_B", B);
    shader.setUniform("p_C", C);
    shader.setUniform("p_D", D);
    shader.setUniform("p_E", E);
    shader.setUniform("p_Z", Z);
}
